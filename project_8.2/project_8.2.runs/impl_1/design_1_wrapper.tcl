namespace eval ::optrace {
  variable script "C:/xproj/project_8.2/project_8.2.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/xproj/project_8.2/project_8.2.cache/wt [current_project]
