...
HD_PWD='C:/xproj/project_8.5/project_8.5.runs/design_3_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_counter_0_0.tcl
