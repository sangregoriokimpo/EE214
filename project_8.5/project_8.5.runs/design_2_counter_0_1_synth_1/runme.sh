...
HD_PWD='C:/xproj/project_8.5/project_8.5.runs/design_2_counter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_counter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_counter_0_1.tcl
