...
HD_PWD='C:/xproj/project_8.5/project_8.5.runs/design_1_clock_divider_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clock_divider_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clock_divider_1_1.tcl
