...
(* CORE_GENERATION_INFO = "design_3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_3,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_3.hwdef" *) 
module design_3
   (CA,
    CB,
    CC,
  ...
  design_3_clock_divider_0_0 clock_divider_0
       (.clk(clock_divider_1_clk_div),
        .clk_div(clock_divider_0_clk_div),
        .rst(rst_1),
        .terminalcount(xlconstant_1_dout));
  design_3_clock_divider_1_0 clock_divider_1
       (.clk(clk_1),
        .clk_div(clock_divider_1_clk_div),
        .rst(rst_1),
        .terminalcount(xlconstant_0_dout));
  design_3_counter_0_0 counter_0
       (.Y(counter_0_Y),
        .clk(clock_divider_0_clk_div));
  design_3_counter_1_0 counter_1
       (.Y(counter_1_Y),
        .clk(clock_divider_0_clk_div));
  design_3_decimal_counter_0_0 decimal_counter_0
       (.Y0(decimal_counter_0_Y0),
        ...
        .clk(clock_divider_0_clk_div),
        .rst(rst_1));
  design_3_decoder_0_0 decoder_0
       (.I(counter_0_Y),
        .Y(decoder_0_Y));
  design_3_display_decoder_0_0 display_decoder_0
       (.B(mux_0_Y),
