...
HD_PWD='C:/xproj/project_12.2/project_12.2.runs/design_1_random_FSM_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_random_FSM_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_random_FSM_0_1.tcl
