...
HD_PWD='C:/xproj/project_12.2/project_12.2.runs/displaycontrollerE1_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displaycontrollerE1_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displaycontrollerE1_decoder_0_0.tcl
