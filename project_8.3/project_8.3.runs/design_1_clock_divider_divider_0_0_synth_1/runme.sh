...
HD_PWD='C:/xproj/project_8.3/project_8.3.runs/design_1_clock_divider_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clock_divider_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clock_divider_divider_0_0.tcl
