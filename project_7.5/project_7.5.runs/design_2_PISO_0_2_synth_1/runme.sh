...
HD_PWD='C:/xproj/project_7.5/project_7.5.runs/design_2_PISO_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_PISO_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_PISO_0_2.tcl
