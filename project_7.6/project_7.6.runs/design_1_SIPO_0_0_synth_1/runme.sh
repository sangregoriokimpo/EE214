...
HD_PWD='C:/xproj/project_7.6/project_7.6.runs/design_1_SIPO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SIPO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SIPO_0_0.tcl
