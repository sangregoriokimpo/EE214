namespace eval ::optrace {
  variable script "C:/xproj/project_9.1A2/project_9.1A2.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/xproj/project_9.1A2/project_9.1A2.cache/wt [current_project]
  set_property parent.project_path C:/xproj/project_9.1A2/project_9.1A2.xpr [current_project]
  set_property ip_output_repo C:/xproj/project_9.1A2/project_9.1A2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/xproj/project_9.1A2/project_9.1A2.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/xproj/project_9.1A2/project_9.1A2.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/xproj/project_9.1A2/project_9.1A2.srcs/constrs_1/new/constraints.xdc
