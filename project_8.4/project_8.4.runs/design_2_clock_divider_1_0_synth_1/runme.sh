...
HD_PWD='C:/xproj/project_8.4/project_8.4.runs/design_2_clock_divider_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_clock_divider_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_clock_divider_1_0.tcl
