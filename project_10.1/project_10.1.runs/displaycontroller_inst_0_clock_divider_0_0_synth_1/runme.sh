...
HD_PWD='C:/xproj/project_10.1/project_10.1.runs/displaycontroller_inst_0_clock_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displaycontroller_inst_0_clock_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displaycontroller_inst_0_clock_divider_0_0.tcl
