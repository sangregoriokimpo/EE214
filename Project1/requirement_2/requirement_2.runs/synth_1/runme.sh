...
HD_PWD='C:/Users/sgk/OneDrive/Desktop/EE214/requirement_2/requirement_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log requirement5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source requirement5.tcl
