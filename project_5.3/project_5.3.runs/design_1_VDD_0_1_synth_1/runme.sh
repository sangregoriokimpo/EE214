...
HD_PWD='C:/xproj/project_5.3/project_5.3.runs/design_1_VDD_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VDD_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VDD_0_1.tcl
