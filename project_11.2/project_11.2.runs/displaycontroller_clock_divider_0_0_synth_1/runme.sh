...
HD_PWD='C:/xproj/project_11.2/project_11.2.runs/displaycontroller_clock_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displaycontroller_clock_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displaycontroller_clock_divider_0_0.tcl
