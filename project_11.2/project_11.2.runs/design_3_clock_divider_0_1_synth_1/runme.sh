...
HD_PWD='C:/xproj/project_11.2/project_11.2.runs/design_3_clock_divider_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_clock_divider_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_clock_divider_0_1.tcl
