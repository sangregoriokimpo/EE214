...
HD_PWD='C:/xproj/project_11.2A2/project_11.2A2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatchE1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatchE1.tcl -notrace
