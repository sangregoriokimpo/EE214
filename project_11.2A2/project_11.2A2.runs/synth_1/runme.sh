...
HD_PWD='C:/xproj/project_11.2A2/project_11.2A2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatchE1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatchE1.tcl
