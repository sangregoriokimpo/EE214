...
HD_PWD='C:/Users/sgk/OneDrive/Desktop/EE214/project_2A1/project_2A1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log duplicateCircuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source duplicateCircuit.tcl
