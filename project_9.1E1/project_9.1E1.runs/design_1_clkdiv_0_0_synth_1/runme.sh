...
HD_PWD='C:/xproj/project_9.1E1/project_9.1E1.runs/design_1_clkdiv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clkdiv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clkdiv_0_0.tcl
