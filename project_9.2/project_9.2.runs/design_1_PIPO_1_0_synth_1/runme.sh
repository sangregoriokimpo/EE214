...
HD_PWD='C:/xproj/project_9.2/project_9.2.runs/design_1_PIPO_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PIPO_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PIPO_1_0.tcl
