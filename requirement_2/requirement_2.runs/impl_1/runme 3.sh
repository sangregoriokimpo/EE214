...
HD_PWD='C:/Users/sgk/OneDrive/Desktop/EE214/requirement_2/requirement_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log requirement5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source requirement5.tcl -notrace
