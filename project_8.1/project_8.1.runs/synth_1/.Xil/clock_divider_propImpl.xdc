set_property SRC_FILE_INFO {cfile:C:/xproj/project_8.1/project_8.1.srcs/constrs_1/new/constraints.xdc rfile:../../../project_8.1.srcs/constrs_1/new/constraints.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { led_clk }]; #IO_L7N_T1_34 Schematic=LD11_B
set_property src_info {type:XDC file:1 line:28 export:INPUT save:INPUT read:READ} [current_design]
create_clock -period 1000000 [get_ports {led_clk}]  # 1 second period (~1 Hz)
