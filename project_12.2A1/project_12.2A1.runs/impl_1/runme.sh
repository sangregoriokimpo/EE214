...
HD_PWD='C:/xproj/project_12.2A1/project_12.2A1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RTME2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RTME2.tcl -notrace
