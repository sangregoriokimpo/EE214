...
HD_PWD='C:/xproj/project_12.2A1/project_12.2A1.runs/displayE1_display_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displayE1_display_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displayE1_display_decoder_0_0.tcl
