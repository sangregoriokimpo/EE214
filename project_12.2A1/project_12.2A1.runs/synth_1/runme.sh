...
HD_PWD='C:/xproj/project_12.2A1/project_12.2A1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTME2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTME2.tcl
