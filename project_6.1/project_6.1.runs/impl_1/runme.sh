...
HD_PWD='C:/xproj/project_6.1/project_6.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CombCirc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CombCirc.tcl -notrace
