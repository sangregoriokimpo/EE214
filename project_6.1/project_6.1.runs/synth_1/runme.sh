...
HD_PWD='C:/xproj/project_6.1/project_6.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CombCirc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CombCirc.tcl
